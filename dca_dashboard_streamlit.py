...
with st.spinner("Chargement des données…"):
    price_df = # Récupère 5 ans pour calculs
price_df_full = fetch_etf_prices(etfs, days=5*365)
# Extrait 1 an par défaut pour affichage
display_df = price_df_full.tail(252)
